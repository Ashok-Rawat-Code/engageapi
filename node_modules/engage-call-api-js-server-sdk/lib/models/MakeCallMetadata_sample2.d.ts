export declare type MakeCallMetadata_sample2 = {
    /**
    ...
    To: string;
    /**
     * Optional. This parameter is used to define the inline EML document. No default value is defined. If inline EML is specified, you should not include Url or ApplicationID parameter in the same REST API request, otherwise an error will be returned
     */
    Eml?: string;
    /**
     ...
     */
    StatusCallbackMethod?: MakeCallMetadata_sample2.StatusCallbackMethod;
    /**
     ...
     */
    Type?: MakeCallMetadata_sample2.Type;
    /**
     ...
     */
    Bridge?: MakeCallMetadata_sample2.Bridge;
};
export declare namespace MakeCallMetadata_sample2 {
    /**
     * Optional. This parameter specifies which HTTP method should be used to request the StatsCallback URL (if specified) when sending the call status event. Valid parameters are GET and POST. Default value is POST.
     */
