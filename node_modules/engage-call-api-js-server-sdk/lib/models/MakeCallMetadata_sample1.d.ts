export declare type MakeCallMetadata_sample1 = {
    /**
    ...
    To: string;
    /**
     * Optional. This parameter is used to define the EDP internal application ID. No default value is defined. If you create the application in EDP using internal EML or VDT or Bot flow studio, specify the corresponding application ID here. If an application ID is specified here, you should not include Url or Eml parameter in the same REST API request, otherwise an error will be returned.
     */
    ApplicationID?: string;
    /**
     * Optional. This parameter defines the URL of the customer application to receive and handle status event generated from this call. No default value is defined. After call connects, Radisys EDP will send any update of the call status to this URL, if this URL is specified.
     */
     ...
     */
    StatusCallbackMethod?: MakeCallMetadata_sample1.StatusCallbackMethod;
    /**
     ...
     */
    Type?: MakeCallMetadata_sample1.Type;
    /**
     ...
     */
    Bridge?: MakeCallMetadata_sample1.Bridge;
};
export declare namespace MakeCallMetadata_sample1 {
    /**
     * Optional. This parameter specifies which HTTP method should be used to request the StatsCallback URL (if specified) when sending the call status event. Valid parameters are GET and POST. Default value is POST.
     */
