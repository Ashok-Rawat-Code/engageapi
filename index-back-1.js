...
app.post("/transfer-status", function (req, res) {
  //console.log("Printing parameters received for /transfer-status (POST) ");
  
    // console.log(JSON.stringify(req.body, null, 1));
  
    //console.log(JSON.stringify(req.body.CallSessionId));
    ...
    //transferCallEngageUpdateAPI(req.body)
    //getCallRecordById(CallSessionID)
...
async function transferCallEngageUpdateAPI(from, to, sessionId) {
...
async function getCallRecordById(crid) {
  ...
  AC_ID, 'CR-2a72dcfa-6161-3689-4f8f-853d-e290f01226d2')
  .then(function (response) {
  console.log("Request sent successfully:  "+ response);
  console.log("Request Body: "+ CallApi.CallService.body);
  })
  .catch(function (error) {
  console.log("Error encountered:  " + error );
  console.log("Request Body: "+ CallApi.CallService.body);
...
*/
 ...
 try {
  ...
  async function sendHttpRequest(url,  headers) {
    try {
        //console.log(headers);
